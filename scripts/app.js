function init() {
    ...
    const languages = [
      ...
      'Cisco Cyber Threat Managements',
      'Cisco Data Analytics Essentials',
      'AWS Academy Cloud Developing'
    ]
  
    const softSkill  = [
      'AICTE Virtual Internship on AI-ML(May-July,2019)'
    ]
    ...
    const linkNames = ['top','about', 'contact']
    ...
    const hoverTextEffect = () =>{
      title.innerHTML = ''
      triggerShuffle(title, 'Jeevesh Patel', 4)
    }
    ...
    window.onload = function() {
      ...
      setTimeout(()=>{
        ...
        triggerShuffle(title, 'Jeevesh Patel', 4)
        triggerShuffle(intro, 'Front end developer', 6)
